...
\frame{
	...
	\begin{itemize}
		...
		\item Stupnice pH by měla rozsah 0--30 (K = 10$^{-30}$).
...
\frame{
	...
	\begin{itemize}
		...
		\item Předpokládaná elektronové konfigurace: [Rn] 5f$^{14}$ 6d$^{10}$ 7s$^2$ 7p$^3$.
	\end{itemize}
...
\frame{
	...
	\textbf{Arsenopyrit}
	\begin{itemize}
		\item Arsenopyrit, \ce{FeAsS}, je monoklinický minerál.\footnote[frame]{\href{http://webmineral.com/data/Arsenopyrite.shtml}{Arsenopyrite Mineral Data}}$^,$\footnote[frame]{\href{https://mineraly.sci.muni.cz/sulfidy/arzenopyrit.html}{Atlas minerálů}}
		\item Často se vyskytuje v přítomnosti zlata, proto se využívá jako indikátor zlatých žil.
		\item Při rozpuštění v kyselině dusičné uvolňuje síru.
	\end{itemize}
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
...
\frame{
	...
	\begin{itemize}
		...
		\item V roce 2019 bylo vyrobeno 160 000 tun antimonu.
		\item Sulfidické rudy jsou pražením převedeny na oxid:\footnote[frame]{\href{https://www.researchgate.net/publication/299133344_Antimony_Production_and_Commodites}{Antimony Production and Commodites}}
...
\frame{
	...
	\begin{figure}
		\begin{figure}
			...
			\caption*{Světová produkce antimonu v letech 1900--2005.\footnote[frame]{Zdroj: \href{https://commons.wikimedia.org/wiki/File:Antimony_-_world_production_trend.svg}{Leyo/Commons}}}
		\end{figure}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item Nejdůležitějšími rudami jsou bismit a bismutin.
...
\frame{
	...
	\begin{itemize}
		...
		\item Oxid arsenitý se používají k odbarvování lahvového skla.
...
\frame{
	...
	\begin{itemize}
		...
		\item \ce{AsCl3 + LiAlH4 ->[Et2O] AsH3 + LiCl + AlH3}
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{itemize}
				...
				\item Marshův test provedl španělský toxikolog Mathieu Joseph Bonaventure Orfila.
		...
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[width=.8\textwidth]{img/Lafarge.jpg}
...
\frame{
	...
	\begin{itemize}
		...
		\item \ce{2 Sb2O3 + 9 O2 -> 2 Sb2O3 + 6 SO2}
...
\frame{
	...
	\begin{itemize}
		...
		\item Můžeme ho připravit buď oxidací oxidu antimonitého vzduchem nebo tepelným rozkladem oxidu antimoničného:
...
\frame{
	...
	\begin{itemize}
		...
		\item $\beta$ modifikace má strukturu fluoritu a může obsahovat i \ce{Bi^V}, kdz dochází k obsazení vakancí v krystalové struktuře oxidovými anionty.
...
\frame{
	...
	\begin{columns}
		...
		\item Realgar, \ce{As4S4} viz minerály arsenu.
...
\frame{
	...
	\begin{itemize}
		...
		\item Lze ho připravit fluorací \ce{BiF3} pomocí fluoru fluoridu chloritého:\footnote[frame]{\href{https://doi.org/10.1002/zaac.19895760128}{Synthesis and properties of pentavalent antimony and bismuth fluorides}}
		...
		\item \ce{BiF5 + UF4 ->[150 $^\circ$C] UF6 + BiF3}
		\item \ce{3 BiF5 + Br2 ->[180 $^\circ$C] 2 BrF3 + 3 BiF3}
		\item \ce{3 BiF5 + S ->[25 $^\circ$C] SF6 + 3 BiF3}
...
\frame{
	...
	\begin{itemize}
		...
		\item Výměna halogenů mezi \ce{AsF3} a \ce{AsCl3} (za laboratorní teploty) byla prokázána pomocí NMR a Ramanovy spektroskopie.
	...
	\begin{columns}
		\begin{column}{.65\textwidth}
			\begin{itemize}
				...
				\item Využívá se jako žlutý pigment, připravuje se srážením nebo solid-state reakcí směsi \ce{Bi2O3} a \ce{V2O5}.
